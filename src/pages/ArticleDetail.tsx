        ...
        <section className="reading-layout">
          <div className="article-main-column">
            <FadeIn className="reading-card">
              ...
              <figure className="detail-cover"><img src={article.cover_url} alt={`${article.title}封面`} /><figcaption>huiyiziyuan · 让值得记住的片段被认真收藏</figcaption></figure>
            ...
            {related.length > 0 && <section className="related-section"><div className="detail-section-title"><span />相关推荐</div><Stagger className="related-grid" stagger={0.06}>{related.map((item) => <ArticleCard key={item.slug} article={item} compact />)}</Stagger></section>}
          </div>
